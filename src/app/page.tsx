    ...
    <>
      ...
      <nav className="sticky top-0 z-50 border-b border-stone-200 bg-white/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 text-sm font-medium text-stone-600 sm:flex">
            <a href="#about" className="transition-colors hover:text-emerald-700">
              About
            </a>
            <a href="#sports" className="transition-colors hover:text-emerald-700">
              Programs
            </a>
            <a href="#impact" className="transition-colors hover:text-emerald-700">
              Impact
            </a>
            <a href="#gallery" className="transition-colors hover:text-emerald-700">
              Gallery
            </a>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-800 via-emerald-700 to-emerald-900">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-28 text-center sm:py-36">
          {/* Tennis ball accent */}
          <div className="mx-auto mb-8 flex h-16 w-16 items-center justify-center rounded-full bg-amber-400 shadow-lg shadow-amber-400/30">
            <svg
            ...
            >
              ...
              <path d="M2 12c0-3 4-6 10-6s10 3 10 6" />
              <path d="M2 12c0 3 4 6 10 6s10-3 10-6" />
            </svg>
          </div>
          ...
          <p className="mx-auto mt-2 max-w-md text-emerald-200/80">
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-stone-600">
                ...
                <p>
                  ...
                  His dedication goes beyond the court — he&rsquo;s built a culture of
                  inclusivity, sportsmanship, and active living.
                </p>
              </div>
            </div>
          ...
          <div className="mt-14 grid gap-8 sm:grid-cols-3">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm ring-1 ring-stone-200/60 transition-all hover:shadow-md hover:ring-emerald-200">
              ...
              <ul className="mt-5 space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2">
                  ...
                  Beginner clinics &amp; fundamentals
                </li>
                <li className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                  Drilling &amp; strategy sessions
                </li>
                <li className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm ring-1 ring-stone-200/60 transition-all hover:shadow-md hover:ring-emerald-200">
              ...
              <p className="mt-3 text-sm leading-relaxed text-stone-500">
                ...
                and the unique strategies that make this sport so engaging for our
                community.
              </p>
              <ul className="mt-5 space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2">
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-white p-8 shadow-sm ring-1 ring-stone-200/60 transition-all hover:shadow-md hover:ring-emerald-200">
              ...
              <p className="mt-3 text-sm leading-relaxed text-stone-500">
                ...
                tennis experience to the Huntington Lakes courts, helping players of all
                levels improve their serve, volley, and groundstrokes while keeping the
                focus on fun and fitness.
              </p>
              <ul className="mt-5 space-y-2 text-sm text-stone-600">
                <li className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
                  Serve &amp; groundstroke clinics
                </li>
                <li className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
      ...
      <section id="impact" className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-stone-500">
              Robert&rsquo;s contributions go far beyond coaching. He&rsquo;s helped build
              a thriving sports culture that keeps Huntington Lakes active, social, and
              connected.
            </p>
          </div>
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div
                key={item.title}
                className="rounded-2xl border border-stone-200 bg-stone-50 p-6 transition-all hover:border-emerald-200 hover:bg-emerald-50/50"
              >
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-14 grid gap-8 sm:grid-cols-3">
            {[
              {
                quote:
                  "Robert's patience and encouragement helped me go from never holding a paddle to playing in our community league. He makes everyone feel like they belong.",
                name: "Community Member",
                role: "Pickleball Player",
              },
              {
                quote:
                  "What Robert has done for Huntington Lakes is remarkable. He's not just teaching sports — he's bringing people together and keeping our community active and vibrant.",
                name: "Huntington Lakes Resident",
                role: "Tennis & Paddle Player",
              },
              {
                quote:
                  "I moved here not knowing anyone. Through Robert's programs, I've made lifelong friends. The sports are great, but the community he's built is even better.",
                name: "Community Member",
              ...
              <div
                ...
                className="rounded-2xl bg-emerald-700/50 p-8 backdrop-blur-sm"
              >
      ...
      <section id="gallery" className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-base text-stone-500">
              Moments captured from years of coaching, competing, and community building at
              Huntington Lakes.
            </p>
          </div>

          <div className="mt-14">
            {/* Photo album link card */}
            <a
              href="https://photos.app.goo.gl/rmYH9pu5BjZwBcBfA"
              target="_blank"
              rel="noopener noreferrer"
              className="group block overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-50 via-white to-amber-50 ring-1 ring-stone-200/60 transition-all hover:shadow-lg hover:ring-emerald-300"
            >
              <div className="grid gap-1 p-1 sm:grid-cols-4 sm:grid-rows-2">
                {/* Placeholder tiles representing album photos */}
                {[
                  { bg: "bg-emerald-200", label: "Pickleball Clinic" },
                  { bg: "bg-amber-200", label: "Paddle Tennis" },
                  { bg: "bg-emerald-300", label: "Community Tournament" },
                  { bg: "bg-stone-200", label: "Group Photo" },
                  { bg: "bg-amber-100", label: "On the Court" },
                  { bg: "bg-emerald-100", label: "Training Session" },
                  { bg: "bg-stone-300", label: "Awards Ceremony" },
                  { bg: "bg-amber-300", label: "Team Spirit" },
                ].map((tile, i) => (
                  <div
                    key={tile.label}
                    className={`${tile.bg} ${i === 0 ? "sm:col-span-2 sm:row-span-2" : ""} flex aspect-[4/3] items-center justify-center rounded-xl transition-transform group-hover:scale-[0.98]`}
                  >
                    <div className="text-center">
                      <svg
                        className="mx-auto h-8 w-8 text-stone-500/50"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth={1}
                      ...
                      <p className="mt-1 text-xs font-medium text-stone-500/70">{tile.label}</p>
                    </div>
                  </div>
                ))}
              </div>
              <div className="flex items-center justify-center gap-2 border-t border-stone-200/60 px-6 py-5">
                <svg
                ...
                <span className="text-sm font-semibold text-emerald-700 group-hover:text-emerald-800">
                  View Full Photo Album on Google Photos
                </span>
              </div>
            </a>
          </div>
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={tag}
                    className="rounded-full border border-stone-200 bg-white px-3.5 py-1.5 text-xs font-medium text-stone-600"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="flex flex-col items-center gap-4 text-center sm:flex-row sm:justify-between sm:text-left">
            <div>
              ...
              <p className="mt-1 text-xs text-stone-500">
                Volunteer Sports Coach — Huntington Lakes, Delray Beach, FL
              </p>
            </div>
