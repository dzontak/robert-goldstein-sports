    ...
    <>
      ...
      <section id="contact" className="bg-gradient-to-br from-emerald-800 to-emerald-900 py-20 sm:py-28">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          {/* Contact Info */}
          <div className="mx-auto mt-10 max-w-md rounded-2xl border border-white/15 bg-white/10 px-8 py-6 backdrop-blur-sm">
            <h3 className="text-lg font-semibold text-white">Get in Touch</h3>
            <a
              href="mailto:tomats1@aol.com"
              className="mt-3 inline-flex items-center gap-2 text-amber-300 transition-colors hover:text-amber-200"
            >
            ...
            <p className="mt-2 text-sm text-emerald-200/70">
              Questions about programs, schedules, or joining a team? Reach out anytime.
            </p>
          </div>
